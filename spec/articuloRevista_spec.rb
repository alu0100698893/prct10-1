...
describe LinkedRef::ArticuloRevista do
	before :each do
		...
		@libro1 = LinkedRef::ArticuloRevista.new(["Jose Castagnio"], "Técnicas, materiales y aplicaciones en nanotecnología", Date.new(2007, 1, 4), "Acta Bioquímica Clínica Latinoamericana", 2, 41)
		@libro2 = LinkedRef::ArticuloRevista.new(["Pedro Perisco", "Carmen Perisco"], "Acreditación en Chile la experiencia de un lustro", Date.new(1997, 1, 8), "Creatividad, educación y desarrollo", 25)
		@libro3 = LinkedRef::ArticuloRevista.new(["Héctor Valdés", "Paula Áviles", "Mandakovic Bogdashha"], "¿La tierra se toma la revancha?: calentamiento global", Date.new(2008, 1, 10), "Conozca más", 10, 19)
	end
	...
	describe "Debe almacenarse correctamente la referencia" do
		...
		it "Referencia Perisco" do
			expect(@libro1.to_s).to eq("Perisco, P., Perisco, C.\nAcreditación en Chile la experiencia de un lustro.\nCreatividad, educación y desarrollo, (25), agosto 1997.")
		end
		it "Referencia Valdés" do
			expect(@libro1.to_s).to eq("Valdés, H., Áviles, P., Mandakovic, B.\n¿La tierra se toma la revancha?: calentamiento global.\nConozca más, 19 (10), octubre 2008.[")
		end
	end
end